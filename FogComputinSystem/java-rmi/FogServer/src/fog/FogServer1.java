...
public class FogServer1 extends UnicastRemoteObject implements FogService {

    private static final long serialVersionUID = 1L;

    protected FogServer1() throws RemoteException {
        super();
    }
    ...
    private void saveViolationToHDFS(String jsonOutput) {
        ...
        try {
            ...
            String fileName = "FogNode1_" + timestamp + ".json";
            ...
            // ---------- HDFS PUT ----------
            String hdfsCmd =
            		"/home/eimone/hadoop/bin/hdfs dfs -mkdir -p /covid_data/FogNode1 && " +
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Naming.rebind(
                    "rmi://localhost:2000/FogService",
                    server);

            System.out.println(
                    "Fog Node 1 running on port 2000...");
